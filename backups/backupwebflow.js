...
if(!t1.checked || !t2.checked || !h || !j ||( !bchk.checked && !k)|| (!rb2b.checked) || regionList.value !== "EN") {
...
if(rb2b.checked) {
  if(regionList.value === 'EN') {
    validateEORI()
  } else if(regionList.value === "EU-NI" || regionList.value === "PT") {
    validateEUVAT()
  }
}
...
//taxID.addEventListener('input', upBtn);
...
taxID.addEventListener('input', validateVAT);
...
.disabledbtn#checkout-stripe {
    background-color: #CCCCCC !important; /* Grey background color */
...
// Function to remove options by value
function rmOpt(menu, item) {
    const options = menu.getElementsByTagName('option');
...
if (shpc.value === "AT" || shpc.value === "BE" || shpc.value === "BG" || shpc.value === "CY" || shpc.value === "CZ" || shpc.value === "DE" || shpc.value === "DK" || shpc.value === "EE" || shpc.value === "EL" || shpc.value === "ES" || shpc.value === "FI" || shpc.value === "FR" || shpc.value === "HR" || shpc.value === "HU" || shpc.value === "IE" || shpc.value === "IT" || shpc.value === "LT" || shpc.value === "LU" || shpc.value === "LV" || shpc.value === "MT" || shpc.value === "NL" || shpc.value === "PL" || shpc.value === "PT" || shpc.value === "RO" || shpc.value === "SE" || shpc.value === "SI" || shpc.value === "SK" || shpc.value === "XI") return false;
else return true;
}
</script>